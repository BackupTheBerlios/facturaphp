...
<div class="Bloque" align="left">
 ...
 <form action="index.php?actor=usuarios&accion=login" method="POST" enctype="application/x-www-form-urlencoded" name="login">
  ...
  Clave:&nbsp;<input type="password" name="clave" value="MiPass" size="10" maxlength="8" <br
	...
	<p>&nbsp;El registro en este servicio es completamente gratu&iacute;to. Si desea registrarse pulse con el rat&oacute; en este <a link href="index.php?actor=usuarios&accion=registro">enlace</a></p>
</div>
