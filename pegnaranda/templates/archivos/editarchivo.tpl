<form action="{$validaregistrourl}" method="post" name="addarchivo">
	<table border="0" cellspacing="1" cellpadding="1" width="589">
		...
		<tr>
			...
			<td>
				<input type="text" name="abrev" class="formulario" size="10" maxlength="32" value="{$datos.abrev}">
			</td>
		</tr>
		<tr>
			<td width="130">&nbsp;</td>
			...
			<td>
				<input type="text" name="nombre" class="formulario" size="30" maxlength="255" value="{$datos.nombre}">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="3" align="center">
				<input type="hidden" name="aid" value="{$datos.aid}"
