<?php /* Smarty version 2.6.1, created on 2004-03-24 11:44:09
         compiled from document/addrsc.tpl */ ?>
...
" method="post" name="addrsc" enctype="multipart/form-data">
	<table border="0" cellspacing="1" cellpadding="1" width="589">
		...
		<tr>
			...
			<td>
				<input type="text" name="titulo" class="formulario" size="30" maxlength="255" >
			</td>
		</tr>
		<tr>
			<td width="130">&nbsp;</td>
			...
			<td>
				<input type="text" name="url" class="formulario" size="50" maxlength="255" >
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="restringido" value="S" class="formulario">
			</td>
		</tr>
