<?php /* Smarty version 2.6.1, created on 2004-04-04 11:49:28
         compiled from autorizacion/editautorizacion.tpl */ ?>
...
" method="post" name="addseccion">
	<table border="0" cellspacing="1" cellpadding="1" width="589">
		...
		<tr>
			...
			<td>
				<input type="text" name="razon" class="formulario" size="70" maxlength="255" value="<?php echo $this->_tpl_vars['datos']['razon']; ?>
">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="3" align="center">
				<input type="hidden" name="autid" value="<?php echo $this->_tpl_vars['datos']['autid']; ?>
">
