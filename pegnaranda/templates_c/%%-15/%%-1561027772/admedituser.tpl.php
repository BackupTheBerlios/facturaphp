<?php /* Smarty version 2.6.1, created on 2004-04-27 13:45:51
         compiled from usuarios/admedituser.tpl */ ?>
<form action="<?php echo $this->_tpl_vars['valaeditarurl']; ?>
...
" class="formulario" size="30" maxlength="160">
		...
		<tr>
			<td align="center" colspan="3">&nbsp;<input type="hidden" name="oldid" value="<?php echo $this->_tpl_vars['datos']['uid']; ?>
"></td>
		</tr>
