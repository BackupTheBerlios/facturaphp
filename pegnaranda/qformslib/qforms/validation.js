...
function _Field_isEmail(){
	...
	if( this.value.indexOf(" ") != -1 ){
		...
		this.error ="Direccion de correo no es valida porque no puede contener un espacio";
	} else if( this.value.indexOf("@") == -1 ){
		//Ruben
		//this.error = "Invalid " + this.description + " address. An e-mail address must contain the @ symbol.";
		this.error ="Direccion de correo no es valida porque debe contener el simbolo @";
	} else if( this.value.indexOf("@") == 0 ){
		// Ruben
		// this.error = "Invalid " + this.description + " address. The @ symbol can not be the first character of an e-mail address.";
		this.error ="Direccion de correo no es valida porque el primer caracter no puede ser una @";
		...
		this.error = "Direccion de correo no es valida porque debe de contener un punto tras la @";
		...
		this.error = "Direccion de correo no es valida porque debe haber algo detras de la @";
	} else if( this.value.lastIndexOf(".") == this.value.length-1 ){
		//Ruben
		//this.error = "Invalid " + this.description + " address. A period can not be the last character of an e-mail address.";
		this.error = "Direccion de correo no es valida porque debe haber algo detras del punto";
	}
}
...
function _Field_isFormat(mask, type){
	...
	if( strMaskLC == "ssn" ){
		...
		strErrorMsg = "El código postal debe contener 5 digitos.";
