...
//variables complementarias	
	...
	function listar($tpl){
		...
		{
			$cadena=''.$tabla_listado->make_tables('vendors',$this->corps_list,array('Nombre',20,'Nombre completo',20,'CIF|NIF',20,'Telefono',20),array($this->ddbb_id_vendor,$this->ddbb_name,$this->ddbb_full_name,$this->ddbb_cif_nif,$this->ddbb_phone),20,$per->permissions_module,$per->add);
			$variables=$tabla_listado->nombres_variables;		
		}		
