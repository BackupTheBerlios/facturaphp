...
//variables complementarias	
	...
	function modules(){
		...
		************************/
		...
		$this->fields_list->add($this->ddbb_id_module, $this->id_module, 'int', 11);
		$this->fields_list->add($this->ddbb_name_web, $this->name_web, 'varchar', 20);
		$this->fields_list->add($this->ddbb_name, $this->name, 'varchar', 20);
		$this->fields_list->add($this->ddbb_path, $this->path, 'varchar', 20);
		$this->fields_list->add($this->ddbb_active, $this->active, 'varchar', 100);		
		//print_r($this);
