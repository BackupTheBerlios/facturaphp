	  ...
	  <table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
			...
			<table width="250px" align="center">
					...
					<tr>
				      ...
				      <tr>
				 	<td colspan="2"><input type="submit" value="Buscar" name="submit_groups_search" class="botones"></td>
				 </tr>
			    <tr>
				  ...
				  <tr>
				 	<td colspan="2"><input type="submit" value="Cambiar nº de registros" name="submit_groups_reg" class="botones"></td>
				 </tr>
