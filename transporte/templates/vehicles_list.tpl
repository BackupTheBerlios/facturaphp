...
{include file=capas.tpl}
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
			  ...
			  <tr><td valign="top"><form method="post" action="index.php?module=vehicles&method=list">
				...
				<tr>
				 	<td colspan="2"><input type="submit" value="Buscar" name="submit_vehicles_search" class="botones"></td>
				 </tr>
			    <tr>
				  ...
				  <tr>
				 	<td colspan="2"><input type="submit" value="Cambiar nº de registros" name="submit_vehicles_reg" class="botones"></td>
				 </tr>
				  </table>
				</form><br>
