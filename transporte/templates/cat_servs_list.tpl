			  ...
			  <tr><td valign="top"><form method="post" action="index.php?module=cat_servs&method=list">
				 ...
				 <tr>
				  ...
				  <tr>
				      ...
				      <tr>
				 	<td colspan="2"><input type="submit" value="Buscar" name="submit_cat_servs_search" class="botones"></td>
				 </tr>
			    <tr>
				  ...
				  <tr>
				 	<td colspan="2"><input type="submit" value="Cambiar nº de registros" name="submit_cat_servs_reg" class="botones"></td>
				 </tr>
				  </table>
				</form><br>
