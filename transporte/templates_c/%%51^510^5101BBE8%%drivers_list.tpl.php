<?php /* Smarty version 2.6.3, created on 2005-01-11 18:04:59
			  ...
			  <tr><td valign="top"><form method="post" action="index.php?module=drivers&method=list">
				 ...
				 <tr>
					 ...
					 <tr>
						...
						<td > <input type="text" id="<?php echo $this->_tpl_vars['objeto']->ddbb_id_driver; ?>
" name="<?php echo $this->_tpl_vars['objeto']->ddbb_id_driver; ?>
" class="textoMenu"></td>
				  </tr>
				<tr>
