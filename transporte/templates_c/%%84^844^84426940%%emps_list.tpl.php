<?php /* Smarty version 2.6.3, created on 2004-11-05 15:48:33
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
			  ...
			  <tr><td valign="top"><form method="post" action="index.php?module=emps&method=view">
				 ...
				 <tr>
					 ...
					 <tr>
						<td width="125px" class="CampoFormulario">Identificador de empleado:</td>
						<td > <input type="text" id="<?php echo $this->_tpl_vars['objeto']->ddbb_id_emp; ?>
" name="<?php echo $this->_tpl_vars['objeto']->ddbb_id_emp; ?>
" class="textoMenu"></td>
				  </tr>
				  <tr>
