<?php /* Smarty version 2.6.3, created on 2005-02-07 17:45:51
			  ...
			  <tr><td valign="top"><form method="post" action="index.php?module=cat_vehicles&method=list">
				 ...
				 <tr>
					 ...
					 <tr>
						...
						<td > <input type="text" id="<?php echo $this->_tpl_vars['objeto']->ddbb_id_cat_vehicle; ?>
" name="<?php echo $this->_tpl_vars['objeto']->ddbb_id_cat_vehicle; ?>
" class="textoMenu"></td>
				  </tr>
				  <tr>
