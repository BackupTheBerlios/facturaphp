<?php /* Smarty version 2.6.3, created on 2005-01-11 18:04:43
			  ...
			  <tr><td valign="top"><form method="post" action="index.php?module=vehicles&method=list">
				 ...
				 <tr>
					 ...
					 <tr>
						...
						<td > <input type="text" id="<?php echo $this->_tpl_vars['objeto']->ddbb_id_vehicle; ?>
" name="<?php echo $this->_tpl_vars['objeto']->ddbb_id_vehicle; ?>
" class="textoMenu"></td>
				  </tr>
				<tr>
